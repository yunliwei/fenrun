...
ActiveRecord::Schema.define(version: 20170326090140) do
  ...
  create_table "adviertisements", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "status"
    t.string   "link"
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
  ...
  create_table "ludans", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "ordernumber"
    t.string   "warename"
    t.string   "payment"
    t.float    "amount",         limit: 24
    t.float    "servicecharges", limit: 24
    t.string   "username"
    t.string   "name"
    t.string   "status"
    t.string   "remark"
